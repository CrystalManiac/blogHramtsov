...
using blogHramtsov.Infrastructure;
using blogHramtsov.Infrastructure.Guarantors;
...
namespace blogHramtsov
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseNpgsql("Username=root;Port=5433; database=myBlog;Password=root;Host=localhost");
            });
